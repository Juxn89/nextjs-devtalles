			...
			<div className="flex flex-col w-[1000px]">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-10">
					...
					<div className="flex flex-col mt-5">
						<span className="text-lg">Fit items in your cart</span>
					...
					<div className="bg-white shadow-lg rounded-lg p-7 h-fit mt-5 md:mt-0">
						...
						<div className="mt-5 mb-2 w-full">
							<p className="text-xs mb-5">
								<span>By placing your order, you agree to our <a href="#" className="underline">Terms and Conditions</a> and <a href="#" className="underline">Privacy Policy</a>.</span>
							</p>
